...
import { getBrokerStatus, listAccounts } from "@/lib/broker-api";
...
/** WP4.2 — Broker Accounts list. Flag-gated: when NEXT_PUBLIC_BROKER_CONNECTIVITY_ENABLED is OFF the
 * route returns 404 (the UI does not exist) BEFORE any data fetch. Per-account broker/status is fetched
