...
/** WP4.2 — Broker account details + validation history + actions (Test / Retry / Replace / Disconnect).
 * Flag-gated 404 when OFF. Test/Retry run inline; Replace/Disconnect use confirmation dialogs. */
export default function BrokerAccountDetailPage() {
  if (!brokerConnectivityEnabled()) notFound();
  ...
  return (
    <div style={{ maxWidth: 860, margin: "0 auto", padding: "1.5rem 1rem" }}>
      <Link href="/broker-accounts" style={{ color: "#93c5fd", fontSize: "0.85rem", textDecoration: "none" }}>← Broker accounts</Link>
