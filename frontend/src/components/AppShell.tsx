...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { labelKey: "nav.invoices", href: "/account/invoices" },
      { labelKey: "nav.usage", href: "/account/usage" },
    ],
  },
  {
...
function navIcon(labelKey: string): ReactNode {
  switch (labelKey) {
    ...
    case "nav.billingPlans":
      return <svg {...NAV_ICON_PROPS}><rect x="1" y="4" width="22" height="16" rx="2" ry="2" /><line x1="1" y1="10" x2="23" y2="10" /></svg>;
    case "nav.invoices":
      return <svg {...NAV_ICON_PROPS}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><line x1="16" y1="13" x2="8" y2="13" /><line x1="16" y1="17" x2="8" y2="17" /><polyline points="10 9 9 9 8 9" /></svg>;
    case "nav.usage":
      return <svg {...NAV_ICON_PROPS}><path d="M21.21 15.89A10 10 0 1 1 8 2.83" /><path d="M22 12A10 10 0 0 0 12 2v10z" /></svg>;
    ...
    case "nav.terminalAccess":
      return <svg {...NAV_ICON_PROPS}><rect x="2" y="3" width="20" height="14" rx="2" ry="2" /><line x1="8" y1="21" x2="16" y2="21" /><line x1="12" y1="17" x2="12" y2="21" /></svg>;
    case "nav.hosting":
