...
from .views import TradingAccountViewSet, TradeViewSet, SyncNowView, SetIngestCutoverView, ValidationTimelineView
...
urlpatterns = [
    ...
    path('validation-timeline/', ValidationTimelineView.as_view(), name='trading-validation-timeline'),
